  ...
  validate(
    z.object({
      body: z.object({
        ...
        constituency: z.string().max(120).optional().or(z.literal("")),
        age: z.preprocess((v) => (v === "" || v === undefined || v === null ? undefined : Number(v)), z.number().min(25).max(120).optional()),
        manifesto: z.string().max(2000).optional().or(z.literal("")),
      }),
      params: z.object({}).optional(),
